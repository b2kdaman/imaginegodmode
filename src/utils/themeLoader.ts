...
const getFallbackThemes = (): ThemesConfig => ({
  ...
  discord: {
    BACKGROUND_DARK: '#202225',
    BACKGROUND_MEDIUM: '#2f3136',
    ...
    SUCCESS: '#5865f2',
    DANGER: '#ef4444',
    PROGRESS_BAR: 'rgba(88, 101, 242, 1)',
    GLOW_PRIMARY: 'rgba(88, 101, 242, 0.6)',
    GLOW_SECONDARY: 'rgba(114, 137, 218, 0.4)',
    GLOW_HOVER_PRIMARY: 'rgba(88, 101, 242, 0.8)',
    GLOW_HOVER_SECONDARY: 'rgba(114, 137, 218, 0.6)',
  },
  champagne: {
    BACKGROUND_DARK: '#2a2520',
    BACKGROUND_MEDIUM: '#3d342c',
    BACKGROUND_LIGHT: '#5a4d3f',
    TEXT_PRIMARY: '#f4e4c1',
    ...
    SUCCESS: '#d4af37',
    DANGER: '#ef4444',
    PROGRESS_BAR: 'rgba(212, 175, 55, 1)',
    GLOW_PRIMARY: 'rgba(212, 175, 55, 0.6)',
    GLOW_SECONDARY: 'rgba(244, 228, 193, 0.4)',
    GLOW_HOVER_PRIMARY: 'rgba(212, 175, 55, 0.8)',
    GLOW_HOVER_SECONDARY: 'rgba(244, 228, 193, 0.6)',
  },
  newyearseve: {
    BACKGROUND_DARK: '#0a0a0a',
    BACKGROUND_MEDIUM: '#1a1a1a',
    ...
    TEXT_PRIMARY: '#ffd700',
    TEXT_SECONDARY: '#ffed4e',
    TEXT_HOVER: '#fff44f',
    SHADOW: 'rgba(0,0,0,0.7)',
    BORDER: 'rgba(255, 215, 0, 0.4)',
    SUCCESS: '#ffd700',
    DANGER: '#ef4444',
    PROGRESS_BAR: 'rgba(255, 215, 0, 1)',
    GLOW_PRIMARY: 'rgba(255, 215, 0, 0.8)',
    GLOW_SECONDARY: 'rgba(255, 237, 78, 0.6)',
    GLOW_HOVER_PRIMARY: 'rgba(255, 215, 0, 1)',
    GLOW_HOVER_SECONDARY: 'rgba(255, 237, 78, 0.8)',
  },
});
